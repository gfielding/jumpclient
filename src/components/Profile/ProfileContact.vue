<template>
    ...
    <div class="mb-3">
    	<div class="flex align-center justify-space-between">
    		...
    		<span v-if="emailVerified" class="verification">verified <i style="color: green" class="fas fa-check"></i></span>
    		<div v-if="!emailVerified">
    			<span class="verification">not verified</span>
    			<button class="btn btn__small btn__accent" @click="resendVerification()">resend</button>
    		</div>
    	</div>
